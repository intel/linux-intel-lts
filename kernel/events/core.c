...
int __weak perf_simd_reg_validate(u16 vec_qwords, u64 vec_mask_intr,
				  u64 vec_mask_user, u16 pred_qwords,
				  u32 pred_mask_intr, u32 pred_mask_user)
{
	return vec_qwords || vec_mask_intr || vec_mask_user ||
...
u64 perf_update_xregs_size(struct perf_event *event, bool intr)
{
	...
	/* vec_mask, vec_qwords, pred_mask, pred_qwords */
	size = sizeof(u64) * 4;
