...
static int rt700_register_sdw_capabilties(struct sdw_slv *sdw,
...
static int rt700_sdw_probe(struct sdw_slv *sdw,
				 const struct sdw_slv_id *sdw_id)
{
	...
	if(!alc700_priv->params) {
		return -ENOMEM;
	}
	regmap = devm_regmap_init_sdwint(sdw, &rt700_sdw_regmap);
	if (!regmap)
		return -EINVAL;
...
static const struct sdw_slv_id rt700_id[] = {
	{"10:02:5d:07:00:00", 0},
	{"11:02:5d:07:00:00", 0},
	{"12:02:5d:07:00:00", 0},
	{"13:02:5d:07:00:00", 0},
...
MODULE_DEVICE_TABLE(sdwint, rt700_id);


static int rt700_sdw_handle_impl_def_interrupts(struct sdw_slv *swdev,
