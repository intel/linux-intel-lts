...
union acpi_object *sdw_dpn_extract_capab(union acpi_object *obj)
{
...
union acpi_object *sdw_scd_extract_capab(union acpi_object *obj)
{
...
union acpi_object *sdw_acpi_init_object(struct device *dev, char path[])
{
