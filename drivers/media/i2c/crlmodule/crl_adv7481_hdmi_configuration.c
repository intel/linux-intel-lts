...
static DEVICE_ATTR(bcaps, 0444, adv_bcaps_show, NULL);
...
static DEVICE_ATTR(bksv, 0220, NULL, adv_bksv_store);
 ...
 */
static DEVICE_ATTR(reauthenticate, 0220, NULL,
...
/* Declares aksv attribute that will be exposed to user space via sysfs,
  ...
  */
static DEVICE_ATTR(aksv, 0444, adv_aksv_show, NULL);
...
static DEVICE_ATTR(hdmi_cable_connected, 0444,
...
static DEVICE_ATTR(bstatus, 0444, adv_bstatus_show, NULL);
