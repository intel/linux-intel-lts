...
#define IMX290_REG_SW_RESET			0x3003
...
/* 222Mbps for imx290 1080p 30fps */
static struct crl_register_write_rep imx290_pll_222mbps[] = {
...
static struct crl_register_write_rep imx290_streamon_regs[] = {
	{0x00, CRL_REG_LEN_DELAY, 20, 0x00},	/* Add a pre 10ms delay */
	{IMX290_REG_STANDBY, CRL_REG_LEN_08BIT, 0x00},
	{0x00, CRL_REG_LEN_DELAY, 50, 0x00},	/* Add a 7ms delay */
	{0x3002, CRL_REG_LEN_08BIT, 0x00},
	{0x00, CRL_REG_LEN_DELAY, 50, 0x00},	/* Add a 10ms delay */
};
...
static struct crl_sensor_detect_config imx290_sensor_detect_regset[] = {
	{
		.reg = { 0x301C, CRL_REG_LEN_08BIT, 0x000000ff },
		.width = 7,
	},	/*Default D1*/
	{
		.reg = { 0x301D, CRL_REG_LEN_08BIT, 0x000000ff },
		.width = 7,
	},	/*Default F0*/
};
...
static struct crl_pll_configuration imx290_pll_configurations[] = {
	{
		.input_clk = 24000000,
		.op_sys_clk = 111375000,/* 222750000/2 */
		.bitsperpixel = 12,
		...
		.comp_items = 0,
		.ctrl_data = 0,
		.pll_regs_items = ARRAY_SIZE(imx290_pll_222mbps),
		.pll_regs = imx290_pll_222mbps,
	},
	{
		.input_clk = 24000000,
