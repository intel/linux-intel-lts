...
/*
 * Definitions for IPU6_V1_PROXY_INT
 */

#if defined(IPU6_V1_PROXY_INT)

/**
 * enum ipu6_v1_ia_css_proxy_write_region. Provides the list of regions for ipu6A0 that
 * can be accessed (for writing purpose) through the proxy interface
 */
enum ipu6_v1_ia_css_proxy_write_region {
	N_IPU6_V1_IA_CSS_PROXY_WRITE_REGION
};

#define IPU6_V1_NO_PROXY_WRITE_REGION_AVAILABLE

#ifndef IPU6_V1_NO_PROXY_WRITE_REGION_AVAILABLE
struct ia_css_proxy_write_region_description ipu6_v1_reg_write_desc[N_IPU6_V1_IA_CSS_PROXY_WRITE_REGION] = {
}
#endif /*IPU6_V1_NO_PROXY_WRITE_REGION_AVAILABLE*/

#endif /*defined(IPU6_V1_PROXY_INT)*/
