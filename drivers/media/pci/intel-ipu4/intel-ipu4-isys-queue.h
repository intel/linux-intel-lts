...
struct intel_ipu_isys_frame_counter {
...
int intel_ipu_isys_queue_prepare_frame_counter
	(struct intel_ipu4_isys_video *av,
	 uint32_t frame_counter, uint32_t index);
int intel_ipu_isys_req_match_frame_counter
...
int intel_ipu4_isys_req_prepare(struct media_device *mdev,
				 struct intel_ipu4_isys_request *ireq,
				 struct intel_ipu4_isys_pipeline *ip,
				 struct ipu_fw_isys_frame_buff_set_abi *set);
