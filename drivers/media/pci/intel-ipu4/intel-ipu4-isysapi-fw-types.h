...
/*
 * enum ipu_fw_isys_link_id. Lists the link ids used by
 * the FW for On The Fly feature
 */
enum ipu_fw_isys_link_id {
	IPU_FW_ISYS_LINK_OFFLINE = 0,
	IPU_FW_ISYS_LINK_MAIN_OUTPUT  = 1,
	IPU_FW_ISYS_LINK_PDAF_OUTPUT  = 2,
	N_IPU_FW_ISYS_LINK_ID
};
