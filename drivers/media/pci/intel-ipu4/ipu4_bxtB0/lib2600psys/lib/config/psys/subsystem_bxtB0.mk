...
PSYS_SERVER_MAX_BUFFER_SET_SIZE			= 64
...
PSYS_SERVER_CACHE_1_PROC_GRP_SIZE		= $(PSYS_SERVER_MAX_PROC_GRP_SIZE)
PSYS_SERVER_CACHE_1_MANIFEST_SIZE		= $(PSYS_SERVER_MAX_MANIFEST_SIZE)
PSYS_SERVER_CACHE_1_CLIENT_PKG_SIZE		= $(PSYS_SERVER_MAX_CLIENT_PKG_SIZE)
PSYS_SERVER_CACHE_1_BUFFER_SET_SIZE		= $(PSYS_SERVER_MAX_BUFFER_SET_SIZE)
PSYS_SERVER_CACHE_1_NUMBER_OF_TERMINAL_SECTIONS	= $(PSYS_SERVER_MAX_NUMBER_OF_TERMINAL_SECTIONS)
PSYS_SERVER_CACHE_2_PROC_GRP_SIZE		= $(PSYS_SERVER_MAX_PROC_GRP_SIZE)
PSYS_SERVER_CACHE_2_MANIFEST_SIZE		= $(PSYS_SERVER_MAX_MANIFEST_SIZE)
PSYS_SERVER_CACHE_2_CLIENT_PKG_SIZE		= $(PSYS_SERVER_MAX_CLIENT_PKG_SIZE)
PSYS_SERVER_CACHE_2_BUFFER_SET_SIZE		= $(PSYS_SERVER_MAX_BUFFER_SET_SIZE)
PSYS_SERVER_CACHE_2_NUMBER_OF_TERMINAL_SECTIONS	= $(PSYS_SERVER_MAX_NUMBER_OF_TERMINAL_SECTIONS)
PSYS_SERVER_CACHE_3_PROC_GRP_SIZE		= $(PSYS_SERVER_MAX_PROC_GRP_SIZE)
PSYS_SERVER_CACHE_3_MANIFEST_SIZE		= $(PSYS_SERVER_MAX_MANIFEST_SIZE)
PSYS_SERVER_CACHE_3_CLIENT_PKG_SIZE		= $(PSYS_SERVER_MAX_CLIENT_PKG_SIZE)
PSYS_SERVER_CACHE_3_BUFFER_SET_SIZE		= $(PSYS_SERVER_MAX_BUFFER_SET_SIZE)
PSYS_SERVER_CACHE_3_NUMBER_OF_TERMINAL_SECTIONS	= $(PSYS_SERVER_MAX_NUMBER_OF_TERMINAL_SECTIONS)