...
/* ADL-P*/
#define ADL_P_PAD_OWN	0x020
#define ADL_P_PADCFGLOCK	0x080
#define ADL_P_HOSTSW_OWN	0x0b0
#define ADL_P_GPI_IS	0x100
#define ADL_P_GPI_IE	0x120
...
#define ADL_COMMUNITY(b, s, e, po, pl, ho, is, ie, g)			\
	{						\
		.barno = (b),				\
		.padown_offset = (po),		\
...
#define ADL_S_COMMUNITY(b, s, e, g)			\
	ADL_COMMUNITY(b, s, e, ADL_PAD_OWN, ADL_PADCFGLOCK, ADL_HOSTSW_OWN, ADL_GPI_IS, ADL_GPI_IE, g)
...
static const struct intel_community adlp_communities[] = {
	ADL_P_COMMUNITY(0, 0, 66, adlp_community0_gpps),
	ADL_P_COMMUNITY(1, 67, 172, adlp_community1_gpps),
	ADL_P_COMMUNITY(2, 173, 261, adlp_community4_gpps),
	ADL_P_COMMUNITY(3, 262, 278, adlp_community5_gpps),
};
...
MODULE_AUTHOR("Jyothi A <jyothix.a@intel.com>");
