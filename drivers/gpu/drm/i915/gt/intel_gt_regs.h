...
#define GEN9_CS_DEBUG_MODE2			_MMIO(0x20d8)
#define   GEN11_GLOBAL_DEBUG_ENABLE		REG_BIT(5)
#define   GEN12_INST_STATE_CACHE_INVALIDATE	REG_BIT(6)
...
#define   GEN9_GLOBAL_DEBUG_ENABLE		REG_BIT(6)
...
#define XEHP_TILE2_ADDR_RANGE			MCR_REG(0x4908)
#define XEHP_TILE3_ADDR_RANGE			MCR_REG(0x490C)
...
#define   DEPTH_STALL_DONE_DISABLE		REG_BIT(5)
...
#define XEHP_CACHE_MODE_1			MCR_REG(0x7004)
...
#define PVC_FLAT_CCS_BASE_ADDR_LOWER		MCR_REG(0x8800)
#define   PVC_CCS_ENABLE			REG_BIT(0)
#define   PVC_FLAT_CCS_BASE_LOWER_ADDR_MASK	REG_GENMASK(31, 6)
#define PVC_FLAT_CCS_BASE_ADDR_UPPER		MCR_REG(0x8804)
...
#define   GEN8_DOP_CLOCK_GATE_CFCLK_ENABLE	REG_BIT(2)
#define   GEN8_DOP_CLOCK_GATE_GUC_ENABLE	REG_BIT(4)
#define   GEN8_DOP_CLOCK_GATE_MEDIA_ENABLE	REG_BIT(6)
...
#define   UNSLCG_FTLUNIT_CLKGATE_DIS		REG_BIT(11)
#define   MSQDUNIT_CLKGATE_DIS			REG_BIT(3)
#define   UNSLCG_MCRUNIT_CLKGATE_DIS		REG_BIT(0)
...
#define   SMCR_CLKGATE_DIS			REG_BIT(8)

#define SCCGCTL94D0				MCR_REG(0x94d0)
#define   SCCG_SMCR_CLKGATE_DIS			REG_BIT(0)
...
#define   FTLUNIT_CLKGATE_DIS			REG_BIT(1)

#define SSMCGCTL9520				MCR_REG(0x9520)
#define   SSMCG_SMCR_CLKGATE_DIS		REG_BIT(0)
...
#define   SSMCG_FTLUNIT_CLKGATE_DIS		REG_BIT(2)
...
#define   CGPSF_CLKGATE_DIS			REG_BIT(3)
#define   MCR_CLKGATE_DIS			REG_BIT(0)
...
#define MEDIA_C6_RSDNCY_CNTR_MSB		_MMIO(0xa2ac)
#define   MEDIA_C6_RSDNCY_CNTR_ENABLE		REG_BIT(31)
#define MEDIA_C6_RSDNCY_CNTR_LSB		_MMIO(0xa2b0)

#define RENDER_C6_RSDNCY_CNTR_MSB		_MMIO(0xa2bc)
#define   RENDER_C6_RSDNCY_CNTR_ENABLE		REG_BIT(31)
#define RENDER_C6_RSDNCY_CNTR_LSB		_MMIO(0xa2c0)
...
#define SARCHKMD				MCR_REG(0xb000)
#define   DISABLE_SAMPLER_PREFETCH		REG_BIT(30)

#define GEN8_GARBCNTL				MCR_REG(0xb004)
#define GEN12_GARBCNTL				_MMIO(0xb004)
...
#define GEN9_SCRATCH_LNCF1			MCR_REG(0xb008)
...
#define GEN12_LTCDREG				MCR_REG(0xb120)
#define   SLPDIS				REG_BIT(30)
...
#define XEHPC_L3CLOS_MASK(i)			MCR_REG(0xb194 + (i) * 8) /* L3 CLOS regs */
...
#define EU_GLOBAL_SIP				MCR_REG(0xe42c)

#define EU_PERF_CNTL0				PERF_REG(0xe458)
#define EU_PERF_CNTL4				PERF_REG(0xe45c)

#define TD_ATT(i)				MCR_REG(0xe470 + (i) * 4)
...
#define TD_CLR(i)				MCR_REG(0xe490 + (i) * 4)
...
#define   FPU_RESIDUAL_DISABLE			REG_BIT(14)
...
#define XEHPC_EUSTALL_BASE			MCR_REG(0xe520)
...
#define XEHPC_EUSTALL_BASE_UPPER		MCR_REG(0xe524)

#define XEHPC_EUSTALL_REPORT			MCR_REG(0xe528)
...
#define XEHPC_EUSTALL_REPORT1			MCR_REG(0xe52c)
...
#define XEHPC_EUSTALL_CTRL			MCR_REG(0xe53c)
...
#define GADSS_CHICKEN				MCR_REG(0xe700)
#define   GADSS_LINK_LAYER_DUMMY_DISABLE	REG_BIT(13)
#define   GADSS_READ_COMPRESSION_DISABLE	REG_BIT(6)
#define   GADSS_128B_COMPRESSION_DISABLE_XEHPC	REG_BIT(5)
#define   GADSS_PARITY_ERROR_INJECT		REG_BIT(0)
#define   GADSS_COMPRESSION_MASK		(GADSS_READ_COMPRESSION_DISABLE | \
...
#define   ENABLE_CREDIT_UNIFICATION		REG_BIT(59 - 32)
#define   DISABLE_MF_READ_FIFO_DEPTH_DECREASE	REG_BIT(57 - 32)
...
#define   GEN12_RCU_ASYNC_FLUSH_ENGINE_ID_SHIFT	28
#define   GEN12_RCU_ASYNC_FLUSH_ENGINE_ID_DECODE1 REG_BIT(26)
#define   GEN12_RCU_ASYNC_FLUSH_AMFS		REG_BIT(8)
#define   GEN12_RCU_ASYNC_FLUSH_PREFETCH	REG_BIT(7)
#define   GEN12_RCU_ASYNC_FLUSH_DATA_PORT	REG_BIT(6)
#define   GEN12_RCU_ASYNC_FLUSH_DATA_CACHE	REG_BIT(5)
#define   GEN12_RCU_ASYNC_FLUSH_HDC_PIPELINE	REG_BIT(4)
#define   GEN12_RCU_ASYNC_INVALIDATE_HDC_PIPELINE REG_BIT(3)
#define   GEN12_RCU_ASYNC_INVALIDATE_CONSTANT_CACHE REG_BIT(2)
#define   GEN12_RCU_ASYNC_INVALIDATE_TEXTURE_CACHE REG_BIT(1)
#define   GEN12_RCU_ASYNC_INVALIDATE_INSTRUCTION_CACHE REG_BIT(0)
#define   GEN12_RCU_ASYNC_FLUSH_AND_INVALIDATE_ALL ( \
	GEN12_RCU_ASYNC_FLUSH_AMFS | \
	GEN12_RCU_ASYNC_FLUSH_PREFETCH | \
	GEN12_RCU_ASYNC_FLUSH_DATA_PORT | \
	GEN12_RCU_ASYNC_FLUSH_DATA_CACHE | \
	GEN12_RCU_ASYNC_FLUSH_HDC_PIPELINE | \
	GEN12_RCU_ASYNC_INVALIDATE_HDC_PIPELINE | \
	GEN12_RCU_ASYNC_INVALIDATE_CONSTANT_CACHE | \
	GEN12_RCU_ASYNC_INVALIDATE_TEXTURE_CACHE | \
	GEN12_RCU_ASYNC_INVALIDATE_INSTRUCTION_CACHE)

#define GEN12_RCU_DEBUG_1                      _MMIO(0x14a00)
#define   GEN12_RCU_DEBUG_1_RUNALONE_ACTIVE    REG_BIT(2)
#define   GEN12_RCU_DEBUG_1_CONTEXT_ACTIVE     REG_BIT(0)
...
#define   PVC_RPSTAT1_CHIPLET_FREQ		REG_GENMASK(28, 20)
