...
static const struct pci_device_id intel_lpss_pci_uart_ids[] = {
	/* BXT A-Step */
...
MODULE_DEVICE_TABLE(pci, intel_lpss_pci_uart_ids);

static struct pci_driver intel_lpss_pci_uart_driver = {
	.name = "intel-lpss-uart",
	.id_table = intel_lpss_pci_uart_ids,
	.probe = intel_lpss_pci_probe,
	.remove = intel_lpss_pci_remove,
	.driver = {
		.pm = &intel_lpss_pci_pm_ops,
...
module_pci_driver(intel_lpss_pci_uart_driver);
