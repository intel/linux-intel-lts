...
/* Set multi-analog gain */
#define CRL_CID_ANALOGUE_GAIN_L		(V4L2_CID_CRLMODULE_BASE + 14)
#define CRL_CID_ANALOGUE_GAIN_S		(V4L2_CID_CRLMODULE_BASE + 15)
#define CRL_CID_ANALOGUE_GAIN_VS	(V4L2_CID_CRLMODULE_BASE + 16)

/* Set multi-digital gain */
#define CRL_CID_DIGITAL_GAIN_L		(V4L2_CID_CRLMODULE_BASE + 17)
#define CRL_CID_DIGITAL_GAIN_S		(V4L2_CID_CRLMODULE_BASE + 18)
#define CRL_CID_DIGITAL_GAIN_VS		(V4L2_CID_CRLMODULE_BASE + 19)
